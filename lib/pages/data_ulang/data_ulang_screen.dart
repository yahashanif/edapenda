 ...
 */
    ...
    WidgetImage(
        {required String title, PickedFile? image, required Function() onTap}) {
      return Column(
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<BerkasCubit, BerkasState>(
          ...
          builder: (context, berkasState) {
            return BlocConsumer<DataPesertaCubit, DataPesertaState>(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          BoxGap(height: getActualY(y: 16, context: context)),
                          Text(
                          ...
                          Align(
                            ...
                            child: SizedBox(
                                ...
                                child:
                                    ...
                                    CustomButton(
                                        isLoading:
                                            state is DataPesertaLoading ||
                                                berkasState is BerkasLoading,
                                        text: "Simpan",
                                        onPressed: () {
                                          print(valueProp);
                                          if (_formKey.currentState!
                                            ...
                                            if (valueProp == null) {
                                              ...
                                              if (state.data.jnsPensiun ==
                                                ...
                                                var fileKTP = File(ktp!.path);
                                                var fileKK = File(kk!.path);
                                                var fileNPWP = File(npwp!.path);
                                                context
                                                    .read<BerkasCubit>()
                                                    .postBerkas(
                                                        token: tokenBox
